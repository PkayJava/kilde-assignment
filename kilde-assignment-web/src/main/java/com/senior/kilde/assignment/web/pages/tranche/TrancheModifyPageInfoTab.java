...
public class TrancheModifyPageInfoTab extends ContentPanel {
    ...
    public TrancheModifyPageInfoTab(String id, String name, TabbedPanel<Tab> containerPanel, Map<String, Object> data) {
    ...
    protected void onInitData() {
        ...
        Optional<Tranche> optionalEntity = repository.findById(this.uuid);
        Tranche entity = optionalEntity.orElseThrow();
    ...
    protected void onInitHtml(MarkupContainer body) {
        ...
        this.name_field.add(new TrancheNameValidator(this.uuid));
