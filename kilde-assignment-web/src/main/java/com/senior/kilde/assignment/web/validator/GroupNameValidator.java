...
public class GroupNameValidator implements IValidator<String> {
    ...
    public void validate(IValidatable<String> validatable) {
        ...
        if (name != null && !name.isEmpty()) {
            ...
            GroupRepository repository = context.getBean(GroupRepository.class);
            Optional<Group> optionalEntity = repository.findByName(name);
            Group entity = optionalEntity.orElse(null);
            if (entity != null) {
                if (this.uuid == null) {
