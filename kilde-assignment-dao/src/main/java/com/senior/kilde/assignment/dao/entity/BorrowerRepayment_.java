...
public abstract class BorrowerRepayment_ {
    ...
    public static volatile SingularAttribute<BorrowerRepayment, Double> loanAmount;
    ...
    public static volatile SingularAttribute<BorrowerRepayment, Double> nextPaymentAmount;
